...
@implementation ZZMFFileMHandler
...
- (NSString *)ybmf_codeInfoWithNode:(ZZModelFileNode *)node {
    ...
    if (node.propertyMapper.count > 0) {
        switch (self.modelCreatorConfig.framework) {
            case ZZMFFrameworkYY: [codeInfo appendString:@"+ (NSDictionary *)modelCustomPropertyMapper {\n"];
                break;
            case ZZMFFrameworkMJ: [codeInfo appendString:@"+ (NSDictionary *)mj_replacedKeyFromPropertyName {\n"];
                break;
            default: break;
        }
    ...
    if (node.containerMapper.count > 0) {
        switch (self.modelCreatorConfig.framework) {
            case ZZMFFrameworkYY: [codeInfo appendString:@"+ (NSDictionary *)modelContainerPropertyGenericClass {\n"];
                break;
            case ZZMFFrameworkMJ: [codeInfo appendString:@"+ (NSDictionary *)mj_objectClassInArray {\n"];
                break;
            default: break;
        }
